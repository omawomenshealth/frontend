...
class OnboardingViewModel extends ChangeNotifier {
  ...
  OnboardingViewModel(
    ...
    _tracking = tracking ?? TrackingController.local(_storage);
  ...
  Future<bool> saveAndComplete() async {
    ...
    if (success && _lastPeriodDays.isNotEmpty) {
      success = await _tracking.applyPeriodDayChanges({
        for (final day in _lastPeriodDays) day: true,
      }, syncCloud: false);
    }
