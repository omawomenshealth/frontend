...
class CycleInsightsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: OmaPalette.primary.withValues(alpha: 0.08),
            blurRadius: 20,
            ...
            child: Row(
              children: [
                Icon(
                  ...
                  size: 16,
                  color: OmaPalette.primary.withValues(alpha: 0.7),
                ),
                ...
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 11,
                      color: OmaPalette.muted.withValues(alpha: 0.8),
                    ),
                  ),
                ),
              ],
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Icon(
                  Icons.info_outline,
                  size: 18,
                  color: OmaPalette.textHint.withValues(alpha: 0.6),
                ),
              ),
  ...
  Widget _divider() {
    return Divider(
      color: OmaPalette.textHint.withValues(alpha: 0.15),
      height: 1,
    );
  }
    ...
    switch (status) {
      ...
      case CycleStatus.noData:
        return Container(
          ...
          height: 22,
          decoration: BoxDecoration(
            color: OmaPalette.textHint.withValues(alpha: 0.3),
            shape: BoxShape.circle,
          ),
