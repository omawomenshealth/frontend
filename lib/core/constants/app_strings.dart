...
const Map<_TextKey, String> _turkishTexts = {
  ...
  _TextKey.insightPeriodTrackingTitle: 'İlk adet başlangıcı kaydedildi',
  ...
  _TextKey.insightSymptomMoodBody:
      '“{primary}” ve “{secondary}” aynı gün {count} kez kaydedildi. Bu kayıtlar neden-sonuç ilişkisi göstermez.',
  ...
  _TextKey.insightMoodCyclePhaseTitle: 'Faza göre ruh hâli kaydı',
  _TextKey.insightMoodCyclePhaseBody:
      '“{phase}” için {withTotal} ruh hâli kaydının {withEvent} tanesinde “{mood}” seçildi (%{withPercent}). Diğer fazlardaki {withoutTotal} karşılaştırılabilir kayıtta oran %{withoutPercent}. Bu, neden-sonuç ilişkisi göstermez.',
  _TextKey.insightSymptomCyclePhaseTitle: 'Faza göre belirti kaydı',
  ...
  _TextKey.insightStressCravingTitle: 'Stres ve aşerme kaydı',
  _TextKey.insightStressCravingBody:
      'Stres {withTotal} günde kaydedildi; bu günlerin {withEvent} tanesinde “{craving}” isteği bulunuyor (%{withPercent}). Stres olmayan {withoutTotal} karşılaştırılabilir günde oran %{withoutPercent}. Bu, neden-sonuç ilişkisi göstermez.',
  _TextKey.insightStressFoodTitle: 'Stres ve besin kaydı',
  ...
  _TextKey.insightFoodSensitivityBody:
      '{primary} içeren öğünlerden sonraki {withTotal} kaydın {withEvent} tanesinde {secondary} işaretlendi (%{withPercent}). {primary} olmayan {withoutTotal} karşılaştırılabilir kayıtta oran %{withoutPercent}. Bu bir tanı değildir. Beslenmende kalıcı bir değişiklik yapmadan önce bir sağlık profesyoneliyle görüşebilirsin.',
  ...
  _TextKey.insightDischargeBaselineTitle: 'Akıntı kaydı özeti',
  _TextKey.insightDischargeBaselineBody:
      'Son {color}{consistency} kaydında eşlik eden bir bulgu işaretlenmedi. Berrak veya beyaz akıntı ile kıvam değişimleri döngü boyunca görülebilir. Tek kayıt nedenini göstermez.',
  _TextKey.insightFertileDischargeTitle: 'Akıntı ve tahmini ovülasyon dönemi',
  _TextKey.insightFertileDischargeBody:
      'Son kaydındaki {color}, {consistency} görünüm tahmini ovülasyon dönemine denk geliyor. Bu kayıt ovülasyonu doğrulamaz ve gebelikten korunma yöntemi değildir.',
  _TextKey.insightMenstrualDischargeTitle:
      'Akıntı kaydın adet gününe denk geliyor',
  _TextKey.insightMenstrualDischargeBody:
      'Son {color} akıntı kaydın adet veya kanama gününe denk geliyor. Bu yalnızca zamanlama bilgisi verir; rengin nedenini göstermez. Adet dışında kanlı görünüm tekrarlarsa bir sağlık profesyoneliyle görüşebilirsin.',
  _TextKey.insightDischargeHealthTitle: 'Olağandışı akıntı kaydı',
  _TextKey.insightDischargeHealthBody:
      'Son kayıtta renk, kıvam, koku veya eşlik eden belirtilerden en az biri olağandışı olarak işaretlendi. Uygulama bunun nedenini belirleyemez veya tanı koyamaz. Değişiklik yeniyse, sürerse ya da kötüleşirse bir sağlık profesyoneliyle görüşebilirsin.',
  ...
  _TextKey.insightUnprotectedFertileTitle:
      'Korunmasız ilişki ve tahmini ovülasyon dönemi',
  _TextKey.insightUnprotectedFertileBody:
      'Son korunmasız ilişki kaydın tahmini ovülasyon dönemine denk geliyor. Takvim tahmini ovülasyonu veya gebeliği doğrulamaz. Gebelik istemiyorsan acil korunma seçenekleri zamana bağlı olabilir; bir sağlık profesyoneli veya eczacıdan gecikmeden bilgi alabilirsin.',
  _TextKey.insightConfidenceEmerging: 'İlk bulgular',
  _TextKey.insightConfidenceModerate: 'Orta düzeyde tutarlı',
  _TextKey.insightConfidenceStrong: 'Daha tutarlı örüntü',
  ...
  _TextKey.exploreMenstrualName: 'adet',
  _TextKey.exploreFollicularName: 'foliküler',
  _TextKey.exploreOvulationName: 'ovülasyon',
  _TextKey.exploreLutealName: 'luteal',
  _TextKey.exploreMenstrualDescription: 'Adet günlerine yönelik içerikler',
  _TextKey.exploreFollicularDescription: 'Foliküler faza yönelik içerikler',
  _TextKey.exploreOvulationDescription:
      'Tahmini ovülasyon dönemine yönelik içerikler',
  ...
  _TextKey.insightLearning:
      'Kayıtlar arttıkça kişisel bağlantılar daha net hesaplanır.',
  ...
  _TextKey.cycleDayFormat: 'Döngünün {count}. günü',
  _TextKey.periodDayNumber: '{count}.',
  ...
  _TextKey.modeTrackCycleSubtitle: 'Döngü ve belirti takibi',
  ...
  _TextKey.patternsForming: 'Kişisel örüntüler',
  ...
  _TextKey.moodPattern: 'Ruh hâli eğilimi',
  _TextKey.energyPattern: 'Enerji eğilimi',
  _TextKey.recurringPattern: 'Tekrarlayan eğilim',
  _TextKey.patternEvidence: '{count} kayda dayanıyor',
  ...
  _TextKey.menstrualCycleLength: 'Adet döngüsü süresi (gün)',
  ...
  _TextKey.symptomQuestion: 'Kaydetmek istediğin belirtiler',
  _TextKey.symptom: 'Belirti',
  _TextKey.symptomHint:
      'Hafif belirtiler dahil, kaydetmek istediklerini seçebilirsin.',
  _TextKey.searchSymptoms: 'Belirtilerde ara',
  _TextKey.symptomStrength: 'Belirtiler genel olarak ne kadar şiddetli?',
  _TextKey.symptomOverall: 'Genel ruh hâlin nasıl?',
  ...
  _TextKey.dreamNoteHint: 'Rüya notların iznin olmadan okunmaz veya işlenmez.',
  _TextKey.moodBehindQuestion: 'Bu ruh hâlini etkileyen bir şey var mı?',
  _TextKey.moodContextHint: 'Uygun olan seçenekleri işaretleyebilirsin.',
  _TextKey.omaNote: 'OMA NOTU',
  _TextKey.moodGentleTitle: 'Bugün için seçenekler',
  ...
  _TextKey.insightFeatureBelowTypicalWater:
      'genellikle kaydettiğinden daha az su',
  _TextKey.supplements: 'Takviyeler',
  _TextKey.medications: 'İlaçlar',
  _TextKey.medicationDisclaimer:
      'İlaçların hakkında ayrıntılı bilgi için eczacınla veya doktorunla görüşebilirsin.',
  _TextKey.bowel: 'Bağırsak',
  _TextKey.bowelActivity: 'Bağırsak hareketleri',
  _TextKey.pain: 'Ağrılar',
  _TextKey.sensations: 'Hisler ve ağrılar',
  _TextKey.flow: 'Akış',
  _TextKey.flowIntensity: 'Kanama yoğunluğu',
  _TextKey.periodBleeding: '🩸 Adet kanaması',
  _TextKey.periodPain: 'Adet ağrısı',
  _TextKey.vaginalDischarge: 'Akıntı / servikal mukus',
  ...
  _TextKey.dischargeSymptoms: 'Eşlik eden belirtiler',
  _TextKey.dischargeTrackingHint:
      'Renk tek başına yorumlanamaz. İstersen kıvam, koku ve eşlik eden belirtileri de kaydedebilirsin.',
  _TextKey.dischargeMedicalDisclaimer:
      'Bu takip tanı koymaz veya ovülasyonu doğrulamaz. Olağandışı ya da süren değişiklikler için bir sağlık profesyoneliyle görüşebilirsin.',
  _TextKey.sexualActivityQuestion: 'Bugün cinsel aktivite oldu mu?',
  _TextKey.sexualAfterFeelingQuestion:
      'Cinsel aktivite sonrasında kendini nasıl hissettin?',
  ...
  _TextKey.customDosage: 'Özel miktar gir',
  _TextKey.customDosageHint: 'Örn: 2 ölçek, 250 mg, 1,5 tablet',
  _TextKey.custom: 'Özel...',
  _TextKey.dateAwaiting: 'Tahmin için daha fazla kayıt gerekiyor',
  _TextKey.daysRemaining: 'gün kaldı',
  _TextKey.periodToday: 'Adet başlangıcı bugün olabilir',
  ...
  _TextKey.previousCycleLength: 'Son döngü süresi',
  _TextKey.previousPeriodLength: 'Son adet süresi',
  ...
  _TextKey.regularDifference: 'Döngüler arasında en fazla 7 gün fark var',
  ...
  _TextKey.cycleStatisticsHint:
      'Yeni döngü kayıtları eklendikçe kişisel aralık daha net hesaplanır',
  ...
  _TextKey.quickPeriodSelectHint:
      'Seçtiğin günleri tek seferde kaydedebilirsin',
  ...
  _TextKey.expertArticlesSubtitle: 'Döngü ve sağlık konularındaki yazılar',
  ...
  _TextKey.premiumActiveDescription: 'Premium yazılara artık erişebilirsin.',
  ...
  _TextKey.syncProtectedError:
      'Eşitleme tamamlanamadı. Bu cihazdaki verilerin korundu.',
  _TextKey.syncError: 'Eşitleme hatası: {error}',
  ...
  _TextKey.activeOffset: 'Etkin sapma: +{days} gün',
  _TextKey.reset: 'Sıfırla',
  _TextKey.cloudSyncActive: 'Bulut eşitlemesi açık',
  ...
  _TextKey.deletionFailed:
      'Hesap ve veriler silinemedi. Yeniden deneyebilirsin.',
  ...
  _TextKey.articlesCouldNotLoad: 'Yazılar yüklenemedi.',
  _TextKey.invalidArticleList: 'Sunucudan geçersiz yazı listesi alındı.',
  _TextKey.articleCouldNotLoad: 'Yazı yüklenemedi.',
  _TextKey.invalidArticle: 'Sunucudan geçersiz yazı alındı.',
  ...
  _TextKey.premiumProductNotFound:
      'Premium ürünü Google Play’de bulunamadı. Daha sonra yeniden deneyebilirsin.',
  _TextKey.playStoreConnectionFailed:
      'Google Play bağlantısı kurulamadı: {error}',
  _TextKey.loginBeforePremium:
      'Giriş yaptığında Premium üyeliğin hesabına bağlanır.',
  ...
  _TextKey.loginBeforeRestore:
      'Satın almayı geri yüklemek için giriş yapman gerekiyor.',
  ...
  _TextKey.noActivePremium:
      'Satın alma doğrulandı ancak etkin Premium erişimi bulunamadı.',
  _TextKey.premiumActivated: 'Premium üyeliğin etkinleştirildi.',
  ...
  _TextKey.periodPredictionSummary:
      'Sonraki adet tahmini: {range} · Tahmin güveni: {confidence}',
  _TextKey.periodPredictionLowConfidenceSummary:
      'Sonraki adet tahmini: {range}\nKayıt ekledikçe tahminler daha kişisel hale gelir.',
  _TextKey.dateDisplayPattern: 'dd.MM.yyyy',
  _TextKey.dateTimeDisplayPattern: 'dd.MM.yyyy HH:mm',
  _TextKey.cloudSyncPrivacyNotice:
      'Bulut eşitlemesini seçersen döngü, belirti, ilaç, takviye, hatırlatma planı, aldım/atladım doz yanıtı ve profil ayarların sağlık takibi amacıyla işlenir. Cihaza özel bildirim planlama durumu buluta gönderilmez. Veriler aktarım sırasında TLS, veritabanında kullanıcıya özel AES-256-GCM anahtarıyla korunur. Google yalnızca oturum açma ve satın alma doğrulaması kapsamında hizmet sağlar. Bulut eşitlemesi isteğe bağlıdır. Verilerini dışa aktarabilir, rızanı geri çekebilir veya hesabı tamamen silebilirsin. Test sürümündeki veri sorumlusu iletişim bilgileri üretimden önce tamamlanacaktır.',
...
const Map<_TextKey, String> _englishTexts = {
  ...
  _TextKey.cycleDayFormat: 'Cycle day {count}',
  _TextKey.periodDayNumber: '{count}',
...
class AppStrings {
  ...
  static String cycleDay(int count) =>
      _format(_TextKey.cycleDayFormat, {'count': count});
  static String periodDayNumber(int count) =>
      _format(_TextKey.periodDayNumber, {'count': count});
